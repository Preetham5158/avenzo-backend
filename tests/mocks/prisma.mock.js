...
const mockPrisma = {
    ...
    order: { findUnique: jest.fn(), findFirst: jest.fn(), findMany: jest.fn(), count: jest.fn(), aggregate: jest.fn().mockResolvedValue({ _sum: { total: 0 }, _count: { id: 0 } }), create: jest.fn(), update: jest.fn() },
    ...
    otpChallenge: { create: jest.fn(), findUnique: jest.fn(), findFirst: jest.fn(), update: jest.fn(), deleteMany: jest.fn() },
    orderAttempt: { create: jest.fn(), findMany: jest.fn(), count: jest.fn(), deleteMany: jest.fn() },
    restaurantLead: { create: jest.fn(), findMany: jest.fn(), findUnique: jest.fn(), count: jest.fn(), groupBy: jest.fn().mockResolvedValue([]), update: jest.fn(), updateMany: jest.fn() },
